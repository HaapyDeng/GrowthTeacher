...
public class ChengJiuDaiWanChengFragment extends Fragment {
    ...
    public ChengJiuDaiWanChengFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_cheng_jiu_dai_wan_cheng, container, false);
    ...
    private void getTodoAchieve(CharSequence choose_start_time, CharSequence choose_end_time, String categoryid, String lableid) {
        ...
        String url = getResources().getString(R.string.local_url) + "/v1/achievement/default/statistical/" + "3/" + studentId + "/" + choose_start_time + "/" + choose_end_time + "/" + categoryid + "/" + lableid;
        Log.d("url==>>", url);
