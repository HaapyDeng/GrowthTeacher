...
public class ReviewVideoActivity extends Activity implements View.OnClickListener {
    ...
    private String label, content, video_image, video;
    ...
    private void doGetTaskInfo(String taskId) {
        ...
        client.get(url, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    ...
                    if (code == 0) {
                        ...
                        loadingDialog.dismiss();
                        Toast.makeText(ReviewVideoActivity.this, response.getString("message"), Toast.LENGTH_LONG).show();
                        return;
                    }
            ...
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse) {
                ...
                loadingDialog.dismiss();
                Toast.makeText(ReviewVideoActivity.this, R.string.no_network, Toast.LENGTH_LONG).show();
                return;
            }
        ...
        tv_commit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (contentText[0].equals("")) {
                    Toast.makeText(ReviewVideoActivity.this, "请添加评审内容", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void doCommit(int i, int[] choose_star, String id, String content) {
        loadingDialog = new LoadingDialog(ReviewVideoActivity.this, "加载中...", R.drawable.ic_dialog_loading);
        loadingDialog.show();
        if (NetworkUtils.checkNetWork(ReviewVideoActivity.this) == false) {
            loadingDialog.dismiss();
            Toast.makeText(ReviewVideoActivity.this, R.string.no_network, Toast.LENGTH_LONG).show();
            return;
        }
