...
import com.mpl.GrowthTeacher.Adapter.PImageAdapter;
...
public class ReviewTuWenActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_review_tu_wen);
    ...
    private void doGetTaskInfo(String taskId) {
        ...
        String url = getResources().getString(R.string.local_url) + "/v1/achievement/image/update/" + taskId;
        Log.d("url==>>", url);
        ...
        client.get(url, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    ...
                    if (code == 0) {
                        ...
                        loadingDialog.dismiss();
                        Toast.makeText(ReviewTuWenActivity.this, response.getString("message"), Toast.LENGTH_LONG).show();
                        return;
                    }
            ...
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse) {
                ...
                loadingDialog.dismiss();
                Toast.makeText(ReviewTuWenActivity.this, R.string.no_network, Toast.LENGTH_LONG).show();
                return;
            }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1:
                    ...
                    gridview.setAdapter(new PImageAdapter(ReviewTuWenActivity.this, listImage));
                    ShowPopuWindow();
                    break;
            }
        }
        ...
        tv_commit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (contentText[0].equals("")) {
                    Toast.makeText(ReviewTuWenActivity.this, "请添加评审内容", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void doCommit(int i, int[] choose_star, String id, String content) {
        loadingDialog = new LoadingDialog(ReviewTuWenActivity.this, "加载中...", R.drawable.ic_dialog_loading);
        loadingDialog.show();
        if (NetworkUtils.checkNetWork(ReviewTuWenActivity.this) == false) {
            loadingDialog.dismiss();
            Toast.makeText(ReviewTuWenActivity.this, R.string.no_network, Toast.LENGTH_LONG).show();
            return;
        }
